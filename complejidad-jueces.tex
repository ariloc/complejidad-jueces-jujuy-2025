...
while (arr[j] >= arr[i])
    ...
    \begin{frame}{Página principal}
        \begin{center}
            \includegraphics[width=.8\linewidth]{./res/ou_topbar.png}\tikzmark{ou_topbar}
        \end{center} \pause
    ...
    \begin{frame}[noframenumbering]
        \begin{center}
            \includegraphics[width=.8\linewidth]{./res/ou_problems.png}\tikzmark{ou_problems}
        \end{center} \pause
    ...
    \begin{frame}[noframenumbering]
        \begin{center}
            \includegraphics[width=\linewidth]{./res/ou_searched.png}\tikzmark{ou_searched}
        \end{center} \pause
        \begin{tikzpicture}[remember picture, overlay]
    ...
    \begin{frame}{Estructura de un problema}
        ...
        \begin{enumerate}
            ...
            \begin{center}
                \fbox{
                    \includegraphics[width=.4\linewidth]{./res/ou_problem_title.png}
                }
            \end{center}\pause
...
cout << sum - mini << '\n';
    ...
    \begin{frame}{Seguimos recordando problemas...}
        ...
        \begin{center}
            \href{https://codeforces.com/}{\includesvg[width=.6\linewidth]{./res/cf_logo.svg}}
        \end{center} \pause 
